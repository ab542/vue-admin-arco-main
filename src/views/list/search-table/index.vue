<template>
  <div class="container">
    <Breadcrumb :items="['menu.product_classification.list', 'menu.list.searchTable']" />
...
export default defineComponent({
  setup() {
    ...
    // // 定义条件变量
    // const isProductList = ref<boolean>(route.params.listType === 'product')
    // 根据条件动态生成 items 数组
    // const breadcrumbItems: ComputedRef<string[]> = computed(() => {
    //   if (isProductList.value) {
    //     return ['menu.product_classification.list', 'menu.list.cardList']
    //   }
    //   return ['menu.other.list', 'menu.other.detail']
    // })
